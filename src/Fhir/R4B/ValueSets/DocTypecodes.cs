...
namespace fhirCsR4.ValueSets
{
  ...
  public static class DocTypecodesCodes
  {
    ...
    /// <summary>
    /// Literal for code: CourtesyConsultationUnspecifiedBodyRegionDocument
    /// </summary>
    public const string LiteralCourtesyConsultationUnspecifiedBodyRegionDocument = "25038-1";
