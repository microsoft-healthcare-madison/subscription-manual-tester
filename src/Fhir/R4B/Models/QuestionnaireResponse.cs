...
namespace fhirCsR4.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<QuestionnaireResponseItemAnswer>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<QuestionnaireResponseItem>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "answer":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.QuestionnaireResponseItemAnswer objAnswer = new fhirCsR4.Models.QuestionnaireResponseItemAnswer();
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<QuestionnaireResponse>))]
