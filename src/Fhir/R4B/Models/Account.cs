...
namespace fhirCsR4.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<AccountCoverage>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<AccountGuarantor>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<Account>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        case "coverage":
          ...
          {
            fhirCsR4.Models.AccountCoverage objCoverage = new fhirCsR4.Models.AccountCoverage();
        ...
        case "guarantor":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.AccountGuarantor objGuarantor = new fhirCsR4.Models.AccountGuarantor();
        ...
        case "servicePeriod":
          ServicePeriod = new fhirCsR4.Models.Period();
