...
namespace fhirCsR4.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<CommunicationPayload>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<Communication>))]
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "inResponseTo":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.Reference objInResponseTo = new fhirCsR4.Models.Reference();
        ...
        case "payload":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.CommunicationPayload objPayload = new fhirCsR4.Models.CommunicationPayload();
        ...
        case "_received":
          _Received = new fhirCsR4.Models.Element();
        ...
        case "_sent":
          _Sent = new fhirCsR4.Models.Element();
        ...
        case "topic":
          Topic = new fhirCsR4.Models.CodeableConcept();
