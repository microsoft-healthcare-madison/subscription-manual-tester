...
namespace fhirCsR4.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<ProductShelfLife>))]
  public class ProductShelfLife : BackboneElement,  IFhirJsonSerializable {
    ...
    /// </summary>
    public Quantity PeriodQuantity { get; set; }
    /// <summary>
    /// The shelf life time period can be specified using a numerical value for the period of time and its unit of time measurement The unit of measurement shall be specified in accordance with ISO 11240 and the resulting terminology The symbol and the symbol identifier shall be used.
    /// </summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      {
        writer.WritePropertyName("periodQuantity");
        PeriodQuantity.SerializeJson(writer, options);
      }
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "periodQuantity":
          PeriodQuantity = new fhirCsR4.Models.Quantity();
          PeriodQuantity.DeserializeJson(ref reader, options);
          break;
        ...
        case "_periodString":
          _PeriodString = new fhirCsR4.Models.Element();
