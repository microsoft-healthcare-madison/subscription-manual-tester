...
namespace fhirCsR4.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<CodeableReference>))]
  public class CodeableReference : DataType,  IFhirJsonSerializable {
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      ((fhirCsR4.Models.DataType)this).SerializeJson(writer, options, false);
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      ...
      {
        case "concept":
          Concept = new fhirCsR4.Models.CodeableConcept();
        ...
        default:
          ((fhirCsR4.Models.DataType)this).DeserializeJsonProperty(ref reader, options, propertyName);
          break;
      }
    }
