...
namespace fhirCsR4.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<DeviceRequestParameter>))]
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4.Serialization.JsonStreamComponentConverter<DeviceRequest>))]
  public class DeviceRequest : DomainResource,  IFhirJsonSerializable {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "codeReference":
          CodeReference = new fhirCsR4.Models.Reference();
          CodeReference.DeserializeJson(ref reader, options);
          break;

        case "codeCodeableConcept":
          CodeCodeableConcept = new fhirCsR4.Models.CodeableConcept();
        ...
        case "parameter":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.DeviceRequestParameter objParameter = new fhirCsR4.Models.DeviceRequestParameter();
        ...
        case "priorRequest":
          ...
          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4.Models.Reference objPriorRequest = new fhirCsR4.Models.Reference();
